...
const [newTotal, setNewTotal] = useState(0);
  ...
  const calculateFareBreakdown = () => {
    ...
    return {
      baseFare: BaseFare || 0,
      tax: Tax || 0,
      total: PublishedFare || BaseFare + Tax,
    };
  };
        ...
        <Row>
          ...
          <Col lg={4}>
            ...
            <Card className="sticky-top shadow-sm" style={{ top: "20px" }}>
              ...
              <Card.Body>
                {!fareDetails?.Fare ? (
                  /* 🔹 FareQuote not ready yet */
                  <Alert variant="info" className="text-center">
                    <Spinner animation="border" size="sm" className="me-2" />
                    Fetching live fare from airline...
                  </Alert>
                ) : (
                  <>
                    {/* Passenger Count */}
                    ...
                    <div className="insurance-section mb-3 p-3 border rounded">
                      ...
                      {insuranceData?.length > 0 && (
                        <>
                          ...
                          {/* ================= INSURANCE RADIO ================= */}
                          <div className="insurance-option mt-3">
                            {/* YES */}
                            <Form.Check
                              type="radio"
                              id="insurance-yes"
                              ...
                              onChange={() => {
                                if (
                                  ...
                                  setSelectedInsurancePlan(insuranceData[0]); // auto pick first plan
                                }
                              }}
                            />
                    ...
                    <Button
                      ...
                      disabled={loading || !fareDetails?.Fare}
                    >
                      {loading ? (
                        <>
                          <Spinner
