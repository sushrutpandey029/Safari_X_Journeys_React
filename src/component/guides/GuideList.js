...
import { FaMapMarkerAlt, FaStar, FaCheckCircle, FaChevronDown, FaChevronUp } from "react-icons/fa";
...
const GuideList = () => {
  ...
  return (
    <div className="guide-page py-5" style={{ backgroundColor: "#fff", marginTop: "150px" }}>
      <div className="container">
        <div className="row">
          ...
          <div className="col-md-3">
            <div className="filter-box p-3 border rounded shadow-sm">
              ...
              <div className="filter-group mb-3">
                ...
                {toggle.languages && (
                  <div className="filter-options mt-2">
                    {["English", "Hindi", "Spanish", "French", "German", "Mandarin"].map(
                      (lang, i) => (
                        <div key={i} className="form-check">
                          <input type="checkbox" className="form-check-input" id={`lang-${i}`} />
                ...
                {toggle.specialization && (
                  <div className="filter-options mt-2">
                    {[
                      ...
                      <div key={i} className="form-check">
                        <input type="checkbox" className="form-check-input" id={`spec-${i}`} />
                        <label className="form-check-label" htmlFor={`spec-${i}`}>
                          {type}
                        </label>
                      </div>
                    ))}
                  ...
                  <div className="filter-options mt-2">
                    {[5, 4, 3].map((rating) => (
                      <div key={rating} className="form-check">
                        <input type="checkbox" className="form-check-input" id={`rating-${rating}`} />
          ...
          <div className="col-md-9 px-4">
            ...
            >
              {guides.map((guide) => (
                <div key={guide.guideId} className="guide-card border rounded-3 p-3 mb-4 shadow-sm">
                      ...
                      <div className="d-flex justify-content-between align-items-start">
                        <div>
                          <h5 className="fw-bold mb-1">
                            {guide.fullName} <FaCheckCircle className="text-primary small ms-1" />
                          </h5>
                          ...
                          <p className="mb-2 small text-secondary">{guide.professionalSummary}</p>
                        ...
                        <div className="text-end">
                          <div className="fw-semibold">${Math.floor(Math.random() * 50) + 30}/hr</div>
                          <span className="badge bg-light text-success small mt-1">Available Today</span>
                        </div>
                      </div>
      ...
      <button 
        ...
        onClick={() => {
          ...
          handleBookNow(guide.guideId || guide.id);
        }}
      >
        Book Now
      </button>
              ...
              {guides.length === 0 && <p className="text-center text-muted">No guides available.</p>}
            </div>
          </div>
        </div>
      </div>
